    ...
    <Footer style={{ background: '#23365E', color: '#fff', padding: '40px 0', minHeight: 'auto' }}>
      ...
      <div className="footer-mobile" style={{ display: 'none', maxWidth: '1920px', margin: '0 auto', padding: '24px 16px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
          <div>
            <NextImage src="/figma/15:462.png" alt="Логотип ДК ГРУПП — строительная компания" width={180} height={160} quality={80} style={{ width: '180px', height: '160px', objectFit: 'contain', marginBottom: '12px' }} onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
          </div>

          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '24px', alignItems: 'start' }}>
              ...
              <div>
                ...
                {['certificates.pdf', 'СРО.pdf', 'Опросный-лист.docx'].map((doc, idx) => (
                  <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                    ...
                    <span style={{ fontFamily: 'Lato, sans-serif', fontSize: '16px', color: '#fff', textDecoration: 'none' }}>{['Скачать сертификаты', 'Ассоциация «СРО «СВС»', 'Опросный лист для расчета'][idx]}</span>
                  </div>
                ))}
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                  ...
                  <a href="tel:+79119994995" style={{ fontFamily: 'Lato, sans-serif', fontSize: '16px', color: '#fff', textDecoration: 'none' }}>+7 (911) 999-49-95</a>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ width: '32px', height: '32px', borderRadius: '8px', backgroundColor: 'rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  ...
                  <a href="mailto:DK-Group1@yandex.ru" style={{ fontFamily: 'Lato, sans-serif', fontSize: '16px', color: '#fff', textDecoration: 'none' }}>DK-Group1@yandex.ru</a>
                </div>
              </div>
            </div>
          </div>

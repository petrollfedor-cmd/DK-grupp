          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            {showPartners && (
              <div style={{ marginTop: '12px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px' }}>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:119.png" alt="Express" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:121.png" alt="Book Store" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:122.png" alt="Color Lab" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:123.png" alt="Glow" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:124.png" alt="X-Trade" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:125.png" alt="Touch" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/private-glass.svg" alt="Private Glass" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/tsi-logo.svg" alt="АО ЦСИ" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
                <div style={{ height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/rubez-logo.png" alt="Рубеж" width={110} height={70} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain' }} /></div>
              </div>
            )}
          </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '40px', alignItems: 'start' }}>
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', justifyContent: 'center', maxWidth: '346px' }}>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:119.png" alt="Express" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:121.png" alt="Book Store" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:122.png" alt="Color Lab" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:123.png" alt="Glow" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:124.png" alt="X-Trade" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/370:125.png" alt="Touch" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/private-glass.svg" alt="Private Glass" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/tsi-logo.svg" alt="АО ЦСИ" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                  <div style={{ width: '110px', height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}><NextImage src="/figma/rubez-logo.png" alt="Рубеж" width={110} height={70} style={{ width: '80%', height: '80%', objectFit: 'contain' }} /></div>
                </div>
              </div>
